...
//
// One-shot smoke test for today's emergency-access work. Validates the
// 6-month gate, 20% rule, R20K hard cap, 90-day overdue check, headroom
// math, and the active-loan branch.
//
// Run with: npx tsx scripts/smoke-emergency-access.mjs

import { computeEmergencyAccess } from "../lib/definitions.ts";
