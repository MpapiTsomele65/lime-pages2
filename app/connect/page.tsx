...
const features = [
  { icon: Users, title: "Member Profiles", desc: "Every Lehumo member gets a professional profile to showcase their business, skills, and services to the community." },
  { icon: Globe, title: "Business Directory", desc: "A curated directory of Black-owned businesses within the Lime Pages community. Support each other, grow together." },
  { icon: Briefcase, title: "Networking", desc: "Connect with like-minded entrepreneurs, investors, and professionals who share your vision for building generational wealth." },
];
        ...
        <Container className="relative z-[1] text-center">
          <motion.div {...fadeUp}>
            ...
            <h1 className="text-[clamp(2.4rem,6vw,4.5rem)] font-extrabold text-white leading-[1.07] tracking-tight mb-6">
              Lime <span className="bg-gradient-to-br from-teal to-lime bg-clip-text text-transparent">Connect</span>
            </h1>
            ...
            <Link href="/lehumo#join" className="inline-flex items-center gap-2 bg-lime text-navy px-9 py-4 rounded-full font-extrabold text-sm hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(184,255,0,0.3)] transition-all">
              Join Lehumo to Get Access <ArrowRight className="w-4 h-4" />
            </Link>
          </motion.div>
        </Container>
      </section>
