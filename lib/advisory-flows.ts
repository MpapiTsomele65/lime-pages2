...
export const FLOWS: Flows = {
  ...
  start: {
    message: `👋 Hey there! Welcome to <strong>Lime Advisors</strong> — your free guide to understanding your financial rights as a South African consumer.<br><br>At Lime Pages, we believe that <strong>building wealth starts with knowing your rights</strong>. Whether you're an entrepreneur, a professional, or just trying to make ends meet — this tool is here to help you stand your ground.<br><br>What kind of issue are you dealing with today?`,
    options: [
      { label: "🏦 Credit, Loans & Debt", next: "nca_main" },
      { label: "📊 Financial Advice, Insurance & Investments", next: "fais_main" },
      ...
      { label: "🛒 Consumer Rights — Goods & Services", next: "cpa_main" },
      { label: "🏛️ Pension & Retirement Savings", next: "pension_main" },
      { label: "💼 Business Funding & Growth", next: "smme_main" },
  ...
  nca_main: {
    message: `The <strong>National Credit Act (NCA)</strong> is one of the strongest consumer protection laws in South Africa. It covers everything from loans and credit cards to store accounts and home loans.<br><br>What's happening in your situation?`,
    options: [
  ...
  nca_refused: {
    message: `<strong>Your right to know why (Section 62, NCA)</strong><br><br>Being told "no" without a reason is not okay. The law is clear — if you ask, they must tell you why.<div class="info-card"><h4>📋 What the law says</h4><ul><li>A credit provider must give you <strong>written reasons</strong> for refusing your application if you ask (s.62)</li><li>You have the right to information in a <strong>language you understand</strong> (s.63) and in <strong>plain language</strong> (s.64)</li><li>Refusing you based on <strong>race, gender, or other discrimination</strong> is illegal (s.61)</li></ul></div><div class="info-card"><h4>✅ What to do — step by step</h4><ul><li><strong>Step 1:</strong> Ask the credit provider <em>in writing</em> for the specific reasons</li><li><strong>Step 2:</strong> Request your free annual credit report to check for issues on your record</li><li><strong>Step 3:</strong> If you were discriminated against, report it to the <strong>NCR</strong></li></ul></div><div class="contact-block"><strong>📞 National Credit Regulator (NCR)</strong>0860 627 627 | www.ncr.org.za</div>`,
    options: [
  ...
  nca_overindebted: {
    message: `<strong>Your right to Debt Review (Section 86, NCA)</strong><br><br>If you genuinely cannot afford to pay all your debts, <strong>debt review is a legal lifeline</strong> — not a punishment.<div class="info-card"><h4>📋 How debt review works</h4><ul><li><strong>Step 1:</strong> Apply to a registered <strong>Debt Counsellor</strong> (NCR-registered)</li><li><strong>Step 2:</strong> The counsellor notifies all credit providers — they <strong>cannot take legal action</strong> while you're under review (s.88)</li><li><strong>Step 3:</strong> A reduced, affordable payment plan is proposed</li><li><strong>Step 4:</strong> Agreement becomes a <strong>court order</strong> — legally binding on all parties</li><li><strong>Step 5:</strong> Once all debts are paid, you receive a <strong>clearance certificate</strong> and your record is cleared (s.71)</li></ul></div><div class="info-card"><h4>⚠️ Important to know</h4><ul><li>Debt review is <strong>not blacklisting</strong> — it is a protection mechanism for you</li><li>You cannot take on new credit while under debt review</li><li>Only use a <strong>registered debt counsellor</strong> — verify on the NCR website</li><li>Be wary of scammers claiming to "clear" your record overnight</li></ul></div><div class="contact-block"><strong>📞 Find a registered debt counsellor:</strong>NCR — 0860 627 627 | www.ncr.org.za</div>`,
    options: [
  ...
  nca_harassment: {
    message: `<strong>Protection from debt collector harassment (Section 133, NCA)</strong><br><br>Debt collectors in South Africa operate within <strong>strict legal limits</strong>. Many of the tactics used every day are flat-out illegal.<div class="info-card"><h4>🚫 What collectors are PROHIBITED from doing</h4><ul><li>Contacting you at <strong>unreasonable hours</strong></li><li><strong>Threatening arrest or criminal charges</strong> — civil debt is NOT a criminal matter</li><li>Using <strong>abusive, threatening, or humiliating language</strong></li><li><strong>Misrepresenting</strong> the amount you owe</li><li>Contacting your <strong>employer, family, or neighbours</strong> to embarrass you</li><li>Collecting a <strong>time-expired (prescribed) debt</strong> without disclosing it's prescribed</li></ul></div><div class="info-card"><h4>✅ What to do right now</h4><ul><li><strong>Step 1:</strong> <em>Document everything</em> — screenshots, call logs, WhatsApp messages</li><li><strong>Step 2:</strong> Ask for the collector's name, employer name, and NCR registration number</li><li><strong>Step 3:</strong> Lodge a complaint with the <strong>NCR</strong></li><li><strong>Step 4:</strong> If harassment continues, approach the <strong>National Consumer Tribunal (NCT)</strong></li></ul></div><div class="contact-block"><strong>📞 Report harassment to:</strong>NCR — 0860 627 627 | www.ncr.org.za<br>NCT — www.thenct.org.za</div>`,
    options: [
  ...
  nca_reckless: {
    message: `<strong>Protection against reckless lending (Sections 80–81, NCA)</strong><br><br>If a lender gave you credit <strong>without properly checking whether you could afford it</strong>, that is <em>reckless credit</em> — and it is illegal.<div class="info-card"><h4>📋 What counts as reckless credit?</h4><ul><li>The credit provider <strong>did not assess your income and expenses</strong> before granting credit</li><li>They assessed it but gave you credit when you were <strong>already over-indebted</strong></li><li>You did not fully understand the <strong>risks, costs or obligations</strong></li></ul></div><div class="info-card"><h4>✅ What can happen</h4><ul><li>A court can <strong>suspend the credit agreement</strong> and reduce your obligations (s.83)</li><li>In serious cases, the court may <strong>write off the debt entirely</strong></li><li>The credit provider can face <strong>fines and regulatory action</strong></li></ul></div><div class="info-card"><h4>✅ What to do</h4><ul><li><strong>Step 1:</strong> Gather your loan documents — was an affordability assessment completed?</li><li><strong>Step 2:</strong> Contact the NCR or a registered debt counsellor</li><li><strong>Step 3:</strong> You can raise reckless lending as a <strong>defence</strong> in court</li></ul></div><div class="contact-block"><strong>📞 NCR — 0860 627 627 | www.ncr.org.za</strong></div>`,
    options: [
  ...
  fais_main: {
    message: `The <strong>FAIS Act</strong> (Financial Advisory and Intermediary Services Act) protects you when you receive financial advice or buy financial products — investments, insurance, retirement annuities, and more.<br><br>What's going on in your situation?`,
    options: [
  ...
  fais_complaint: {
    message: `<strong>How to complain to the FAIS Ombud</strong><br><br>The FAIS Ombud is <strong>independent and free</strong>. You don't need a lawyer.<div class="info-card"><h4>📋 The complaint process</h4><ul><li><strong>Step 1:</strong> Complain to the FSP first (allow ~6 weeks)</li><li><strong>Step 2:</strong> If unresolved — go to <strong>www.faisombud.co.za</strong></li><li><strong>Step 3:</strong> Include: your name, FSP's name, description, and all documents</li><li><strong>Step 4:</strong> The Ombud tries <strong>conciliated settlement</strong> first</li><li><strong>Step 5:</strong> If no settlement — a <strong>final, binding determination</strong></li></ul></div><div class="info-card"><h4>⚠️ Key reminders</h4><ul><li>Complain within <strong>3 years</strong></li><li>The service is <strong>100% free</strong></li><li>A determination has the force of a <strong>court judgment</strong></li></ul></div><div class="contact-block"><strong>📞 FAIS Ombud — 0860 324 766</strong><br>www.faisombud.co.za | info@faisombud.co.za</div>`,
    options: [
      { label: "🏠 Back to Financial Advice menu", next: "fais_main" },
      { label: "🔄 Start over", next: "start" },
    ],
  ...
  pension_main: {
    message: `The <strong>Pension Funds Act</strong> and the <strong>Two-Pot Retirement System</strong> (effective 1 September 2024) give South Africans new rights around their retirement savings.<br><br>What do you need help with?`,
    options: [
  ...
  pension_complaint: {
    message: `<strong>How to complain about your pension fund</strong><div class="info-card"><h4>📋 The Pension Funds Adjudicator (PFA)</h4><ul><li>Independent, <strong>free</strong> complaints body</li><li>Complain within <strong>3 years</strong></li><li>Determination is binding — enforceable like a court order</li></ul></div><div class="info-card"><h4>✅ Step by step</h4><ul><li><strong>Step 1:</strong> Raise the issue with your fund administrator in writing</li><li><strong>Step 2:</strong> Allow at least 30 days to respond</li><li><strong>Step 3:</strong> If unresolved — submit to the <strong>PFA</strong></li></ul></div><div class="contact-block"><strong>📞 Pension Funds Adjudicator</strong><br>012 346 1738 | www.pfa.org.za</div>`,
    options: [
      { label: "⚠️ I think I'm being scammed", next: "two_pot_scams" },
      { label: "🏠 Back to Pension menu", next: "pension_main" },
      { label: "🔄 Start over", next: "start" },
  ...
  cpa_main: {
    message: `The <strong>Consumer Protection Act (CPA)</strong> — Act 68 of 2008 — gives you powerful rights whenever you buy goods or services in South Africa.<br><br>What's your situation?`,
    options: [
  ...
  cpa_misleading: {
    message: `<strong>False advertising and misleading marketing (Sections 29–41, CPA)</strong><div class="info-card"><h4>🚫 Prohibited practices</h4><ul><li><strong>False, misleading, or deceptive</strong> representations (s.41)</li><li><strong>"Bait marketing"</strong> — advertising without reasonable stock (s.30)</li><li>Fake "was/now" pricing</li><li>Charging <strong>more than the lowest displayed price</strong> (s.23)</li><li>Using <strong>coercion or undue influence</strong> (s.40)</li></ul></div><div class="info-card"><h4>✅ What to do</h4><ul><li><strong>Step 1:</strong> Document everything — screenshots, receipts</li><li><strong>Step 2:</strong> Demand the advertised price or a refund in writing</li><li><strong>Step 3:</strong> If refused — report to the <strong>NCC</strong></li><li><strong>Step 4:</strong> For false advertising — also report to the <strong>Advertising Regulatory Board</strong></li></ul></div><div class="contact-block"><strong>📞 NCC — 0860 266 786</strong><br>Advertising Regulatory Board: www.arb.org.za</div>`,
    options: [
      { label: "📝 How do I complain formally?", next: "cpa_complaint" },
      { label: "🏠 Back to Consumer Rights menu", next: "cpa_main" },
      { label: "🔄 Start over", next: "start" },
  ...
  cpa_pyramid: {
    message: `<strong>Pyramid schemes & scams (Sections 42–43, CPA)</strong><br><br>These are <strong>criminal offences under the CPA</strong>.<div class="info-card"><h4>🚨 What makes it a pyramid scheme? (s.43)</h4><ul><li>Earn money <strong>primarily by recruiting new members</strong></li><li>New recruits pay to join and money flows up</li><li>Eventually collapses — most participants lose everything</li></ul></div><div class="info-card"><h4>🚨 Multiplication Schemes (s.43(3))</h4><ul><li>Promises returns of <strong>more than 20% above Repo Rate</strong> — illegal</li><li>Often presented as "guaranteed returns"</li></ul></div><div class="info-card"><h4>✅ What to do</h4><ul><li><strong>Do not pay anything</strong> until verified with a professional</li><li>Check for an <strong>FSP licence</strong> on www.fsca.co.za</li><li>Report to the <strong>NCC</strong> and <strong>FSCA</strong></li><li>Report fraud to <strong>SAPS</strong></li></ul></div><div class="contact-block"><strong>📞 NCC — 0860 266 786</strong><br>FSCA: www.fsca.co.za | SAPS: 10111</div>`,
    options: [
      { label: "📝 How do I complain formally?", next: "cpa_complaint" },
      { label: "🏠 Back to Consumer Rights menu", next: "cpa_main" },
      { label: "🔄 Start over", next: "start" },
